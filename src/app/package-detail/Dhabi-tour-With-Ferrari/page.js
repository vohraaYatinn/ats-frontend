...
const Page = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      sendEmail(formData?.fullName, formData?.email, formData?.countryCode + formData?.phone, "Abu Dhabi City Tour With Ferrari World", formData?.message)
      ...
      <div className="container"> 
        ...
        <div className="row g-xl-4 gy-5 main-package-details-div">
          <div className="col-xl-8">
            ...
            <h2>Abu Dhabi City Tour With Ferrari World
            </h2>
            ...
            <p className="para-activity">Embark on an unforgettable journey through the vibrant city of Abu Dhabi, where tradition meets modernity. This comprehensive tour offers a perfect blend of cultural exploration and thrilling adventure. Visit the iconic Sheikh Zayed Grand Mosque, marvel at the city's architectural wonders, and experience the adrenaline rush at Ferrari World. Our professional guide will ensure you have an enriching and enjoyable experience throughout the tour.
            </p>
            ...
            <div className="highlight-tour mb-20">
              ...
              <ul>
                ...
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Enjoy a city drive-by with photo stops at key landmarks
                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Experience the thrill of Ferrari World
                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Travel in a clean, air-conditioned vehicle
                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Stay hydrated with fresh mineral water provided for all participants
                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Benefit from the expertise of a professional and licensed tour guide
                </li>
              </ul>
            </div>
    ...
    <li><b className="bold-activity">Wheelchair Accessibility:</b> This tour is partially wheelchair accessible. The transportation provided and some of the tour locations may not be equipped to accommodate wheelchair users comfortably. We apologize for any inconvenience this may cause and are available to discuss alternative arrangements or provide recommendations for more accessible tours in the UAE.
            ...
            <div className="includ-and-exclud-area mb-20">
              <ul>
                ...
                <li><i className="bi bi-check-lg" /> Ferrari World For All Participants
            ...
            <li><b className="bold-activity">Pick-Up From Hotel Or Accommodation:</b> Begin your journey with a convenient pick-up from your hotel or accommodation. Our comfortable, air-conditioned vehicle and friendly driver are ready to transport you to an exciting day of exploration.
              ...
              <div className="accordion-item">
                ...
                <div id="collapseOne" className="accordion-collapse collapse show show-date-check"   aria-labelledby="headingOne" data-bs-parent="#tourPlan">
                  <div className="accordion-body">
                    <ul>
                      <li>Marvel at the stunning architecture and serene ambience of one of the world's largest mosques.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingTwo">
                  ...
                  <span>2nd Stop</span> City Drive-By (Photo Stop):
                  </button>
                </h2>
                <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#tourPlan">
                  <div className="accordion-body">
                    <ul>
                    <li>Capture the essence of Abu Dhabi with a drive-by tour of the city's key landmarks, including a photo stop.
                    </li>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingThree">
                  ...
                  <span>3rd Stop</span> Ferrari World:
                  </button>
                </h2>
                <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#tourPlan">
                  <div className="accordion-body">
                    <ul>
                    <li>Experience the thrill of Ferrari World, home to the world's fastest roller coaster and a variety of exciting attractions.
                    </li>
           ...
           <div className="review-section">
            ...
            <h3>Be the first to review “Abu Dhabi City Tour With Ferrari World”</h3>
