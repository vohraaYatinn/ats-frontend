...
const Page = () => {
  ...
  return (
      ...
      <div className="container"> 
        ...
        <div className="row g-xl-4 gy-5 main-package-details-div">
          <div className="col-xl-8">
            ...
            <h2>Dubai Tour With AYA Universe
            </h2>
            ...
            <p className="para-activity">Embark on an unforgettable journey through Dubai's most iconic landmarks and cultural hotspots. This 8-hour tour offers a perfect blend of modern marvels and traditional experiences, culminating in a visit to the vibrant AYA Universe. Whether you're a first-time visitor or a seasoned traveler, this tour promises a comprehensive and enriching experience of Dubai's diverse attractions.
            ...
            <div className="highlight-tour mb-20">
              ...
              <ul>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Visit The Pointe for a stunning photo opportunity

                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Explore the charming Souk Madinat Jumeirah


                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Capture the iconic Burj Al Arab in your photos


                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Marvel at the architectural beauty of the Blue Mosque
                ...
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Discover the historic Al Fahidi District



                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Experience the Modern AYA Universe
    ...
    <li><b className="bold-activity">Liability And Insurance:</b> ATS is not responsible for any damage, loss, accidents, sickness, injury, or death that may occur during the tour. Comprehensive travel and health insurance are advised.
    ...
    <li><b className="bold-activity">Wheelchair Accessibility:</b> This tour is partially wheelchair accessible. The transportation provided and some of the tour locations may not be equipped to accommodate wheelchair users comfortably. We apologize for any inconvenience this may cause and are available to discuss alternative arrangements or provide recommendations for more accessible tours in the UAE.
            ...
            <div className="includ-and-exclud-area mb-20">
              <ul>
                ...
                <li><i className="bi bi-check-lg" /> AYA Universe For All Participants
        ...
        <ul>
          <li>Conclude your tour with a comfortable drop-off at your hotel or accommodation.</li>
           ...
           <div className="review-section">
            ...
            <h3>Be the first to review “Dubai Tour With AYA Universe
            ”</h3>
