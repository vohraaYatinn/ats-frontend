...
const Page = () => {
  ...
  <div className="accordion-item">
    ...
    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#tourPlan">
      <div className="accordion-body">
        <ul>
          <li>Capture stunning views of Atlantis, The Palm from this scenic spot.</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div className="accordion-item">
    ...
    <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#tourPlan">
      <div className="accordion-body">
        <ul>
          <li>Explore this traditional Arabian market with its winding waterways and boutique shops.</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div className="accordion-item">
    ...
    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#tourPlan">
      <div className="accordion-body">
        <ul>
          <li>Take photos of the world-famous, sail-shaped luxury hotel.</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div className="accordion-item">
    ...
    <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#tourPlan">
      <div className="accordion-body">
        <ul>
          <li>Admire the beautiful architecture of this mosque inspired by the Blue Mosque in Istanbul.</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div className="accordion-item">
    ...
    <div id="collapseFive" className="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#tourPlan">
      <div className="accordion-body">
        <ul>
          <li>Dive into the vibrant atmosphere of this traditional market known for its spices, textiles, and gold.</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div className="accordion-item">
    ...
    <div id="collapseSeven" className="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#tourPlan">
      <div className="accordion-body">
        <ul>
          <li>Discover the cultural heritage of Dubai in this historic neighbourhood.</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div className="accordion-item">
    ...
    <div id="collapseEight" className="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#tourPlan">
      <div className="accordion-body">
        <ul>
          <li>Visit the iconic Dubai Frame and enjoy panoramic views of old and new Dubai.</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div className="accordion-item">
    <h2 className="accordion-header" id="headingDropOff">
      <button
        ...
        type="button"
        data-bs-toggle="collapse"
        data-bs-target="#collapseDropOff"
        aria-expanded="false"
    ...
    <div id="collapseDropOff" className="accordion-collapse collapse" aria-labelledby="headingDropOff" data-bs-parent="#tourPlan">
      <div className="accordion-body">
        <ul>
