        ...
        <div className="container">
          ...
          <div className="row g-xl-4 gy-5 main-package-details-div">
            <div className="col-xl-8">
              ...
              <h2>Blue Mosque, Dubai Frame, Dubai Mall, Ferrari World, Miracle Garden, Desert Safari & More
              </h2>
              ...
              <div className="highlight-tour mb-20">
                ...
                <ul>
                  <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Visit the iconic Blue Mosque



                  </li>
                  <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Explore the Dubai Frame




                  </li>
                  <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Shop and dine at the Dubai Mall
                  ...
                  <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Experience the thrill at Ferrari World




                  </li>
                  <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Stroll through the Miracle Garden
                  ...
                  <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Enjoy a Desert Safari with BBQ and entertainment
                  ...
                  <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Professional and licensed tour guide throughout the tour
                  ...
                  <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Convenient pick-up and drop-off from your accommodation
              ...
              <div className="includ-and-exclud-area mb-20 good-to-know">
                <ul>
                  ...
                  <li><b className="bold-activity">Liability And Insurance:</b> ATS is not responsible for any damage, loss, accidents, sickness, injury, or death that may occur during the tours in this package. Comprehensive travel and health insurance are advised. All personal effects are solely your responsibility during the activity.



                  </li><br />

                  <li><b className="bold-activity">Participation Responsibility:</b> Ensure you are mentally and physically prepared for the activities of the tours in this package. You are responsible for assessing your capability to participate in these activities.




                  </li><br />
                  <li><b className="bold-activity">Wheelchair Accessibility:</b> This package is partially wheelchair accessible. The transportation provided and some of the tour locations may not be equipped to accommodate wheelchair users comfortably. We apologize for any inconvenience this may cause and are available to discuss alternative arrangements or provide recommendations for more accessible packages in the UAE.
              ...
              <div className="includ-and-exclud-area mb-20">
                <ul>
                  ...
                  <li><i className="bi bi-check-lg" /> Tickets For All Participants
              ...
              <div className="accordion tour-plan" id="tourPlan">
                ...
                <div className="accordion-item">
                  ...
                  <div id="collapseOne" className="accordion-collapse collapse show show-date-check" aria-labelledby="headingOne" data-bs-parent="#tourPlan">
                    <div className="accordion-body">
                      <ul>
                        <li>1st Stop: Dubai Tour With Burj Khalifa, Fountain Show & Dubai Mall
                ...
                <div className="accordion-item">
                  ...
                  <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#tourPlan">
                    <div className="accordion-body">
                      <ul>
                        <li>1st Stop: Abu Dhabi Tour With Louvre & Grand Mosque




                        </li>
                        <li>2nd Stop: Ferrari World
                ...
                <div className="accordion-item">
                  ...
                  <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#tourPlan">
                    <div className="accordion-body">
                      <ul>
                        <li>1st Stop: Dubai Tour With Garden Glow

                        </li>
                        <li>2nd Stop: Sunset Dubai Desert Safari With BBQ & Entertainment

                        </li>
                        <li>Drop-Off To Hotel Or Accommodation: Conclude your tour with a comfortable drop-off at your hotel or accommodation, bringing an end to a day filled with memorable sights and experiences.
                        </li>
              ...
              <div className="review-section">
                ...
                <h3>Be the first to review “Blue Mosque, Dubai Frame, Dubai Mall, Ferrari World, Miracle Garden, Desert Safari & More
                  ”</h3>
                      ...
                      <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-inner mb-20">
                          ...
                          <div style={{ display: "flex", gap: "10px" }}>
                            <ReactFlagsSelect
                              className="react-select-select-phone phone-react-thing"
                              selected={selected}
