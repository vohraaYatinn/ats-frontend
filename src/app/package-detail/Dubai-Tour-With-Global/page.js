      ...
      <div className="container"> 
        ...
        <div className="row g-xl-4 gy-5 main-package-details-div">
          <div className="col-xl-8">
            ...
            <h2>Dubai City Tour With Global Village
            ...
            <p className="para-activity">Embark on an unforgettable journey through Dubai's most iconic landmarks and cultural hotspots. This 10-hour tour offers a perfect blend of modern marvels and traditional experiences, culminating in a visit to the vibrant Global Village. Whether you're a first-time visitor or a seasoned traveller, this tour promises a comprehensive and enriching experience of Dubai's diverse attractions.
            ...
            <div className="highlight-tour mb-20">
              ...
              <ul>
                ...
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Experience the cultural extravaganza at Global Village
    ...
    <li><b className="bold-activity">Wheelchair Accessibility:</b> This tour is partially wheelchair accessible. The transportation provided and some of the tour locations may not be equipped to accommodate wheelchair users comfortably. We apologize for any inconvenience this may cause and are available to discuss alternative arrangements or provide recommendations for more accessible tours in the UAE.
            ...
            <div className="includ-and-exclud-area mb-20">
              <ul>
                ...
                <li><i className="bi bi-check-lg" /> Global Village For All Participants
...
<div className="accordion-item">
  <h2 className="accordion-header" id="headingEight">
    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
      <span>8th Stop</span> Global Village:
    </button>
  </h2>
  <div id="collapseEight" className="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#tourPlan">
    <div className="accordion-body">
      <ul>
        <li>Experience the cultural extravaganza with pavilions from around the world, offering shopping, dining, and entertainment.</li>
      </ul>
    </div>
  </div>
</div>
      ...
      <ul>
        <li>Conclude your tour with a comfortable drop-off at your hotel or accommodation, bringing an end to a day filled with memorable sights and experiences.</li>
           ...
           <div className="review-section">
            ...
            <h3>Be the first to review “Dubai City Tour With Global Village
            ”</h3>
