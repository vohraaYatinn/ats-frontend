...
import DestinationSearch from "../../../src/components/banner/DestinationSearch";
import TourCategoryDropdown from "../../../src/components/banner/TourCategoryDropdown";
import "@/components/stylebook/Footer.css";
import "./package.css";
import QuantityCounter from "@/uitils/QuantityCounter";
import TourTypeDropdown from "@/components/banner/TourTypeDropdown";
import WhenDropdown from "@/components/banner/WhenDropdown";
    ...
    <>
      ...
      <div className="package-filter">
        <div className="container">
          <div className="home1-banner-bottom style-4 mb-40">
            <div className="filter-wrapper">
              <div className="filter-group">
                <div className="tab-content">
                  <div className="tab-pan" id="activities" role="tabpanel">
                    <form>
                      <div className="filter-area">
                        <div className="row g-xxl-3 gy-4">
                  ...
                  <div className="col-md-4 item">
                    <div className="package-card">
                      <div className="package-card-img-wrap">
                        ...
                        >
                          <img
                            src="/assets/img/home2/package-img-one.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                      ...
                      <div className="package-card-content">
                        <div className="card-content-top">
                          ...
                          <div className="review-item">
                            <div className="stars-cstm">
                              <span>
                                <svg
                                  ...
                                  xmlns="http://www.w3.org/2000/svg"
                                >
                                  <g clip-path="url(#clip0_3135_682)">
                                    <path
                                      d="M5.90909 0.589844L7.735 4.28992L11.8182 4.8828L8.86364 7.7625L9.56091 11.8294L5.90909 9.90946L2.25678 11.8294L2.95455 7.7625L0 4.8828L4.08318 4.28992L5.90909 0.589844Z"
                                      fill="#FFAF22"
                                      stroke="#FFAF22"
                            ...
                            <span className="review-rating">4+Rating</span>
                          </div>
                        </div>
                  ...
                  <div className="col-md-4 item">
                    <div className="package-card">
                      <div className="package-card-img-wrap">
                        ...
                        >
                          <img
                            src="/assets/img/home2/package-img-two.png"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                  ...
                  <div className="col-md-4 item">
                    <div className="package-card">
                      <div className="package-card-img-wrap">
                        ...
                        >
                          <img
                            src="/assets/img/home2/package-img-three.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                      ...
                      <div className="package-card-content">
                        <div className="card-content-top">
                          <h5>
                            <Link href="/package/package-details">Rafting</Link>
                          </h5>
                          <div className="review-item">
                            <div className="stars-cstm">
                              <span>
                  ...
                  <div className="col-md-4 item">
                    <div className="package-card">
                      <div className="package-card-img-wrap">
                        ...
                        >
                          <img
                            src="/assets/img/home2/package-img-four.png"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                  ...
                  <div className="col-md-4 item">
                    <div className="package-card">
                      <div className="package-card-img-wrap">
                        ...
                        >
                          <img
                            src="/assets/img/home2/package-img-five.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                  ...
                  <div className="col-md-4 item">
                    <div className="package-card">
                      <div className="package-card-img-wrap">
                        ...
                        >
                          <img
                            src="/assets/img/home2/package-img-six.png"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                      ...
                      <div className="package-card-content">
                        <div className="card-content-top">
                          <h5>
                            <Link href="/package/package-details">Surfing</Link>
                          </h5>
                          <div className="review-item">
                            <div className="stars-cstm">
                              <span>
