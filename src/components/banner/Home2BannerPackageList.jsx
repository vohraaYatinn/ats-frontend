...
const Home2BannerPackgeList = () => {
    const [isActive, setIsActive] = useState(false);

    useEffect(() => {
        // Function to check the window width and set the active state
        const handleResize = () => {
                    ...
                    <div className="container-md container-fluid">
                        <div className="filter-wrapper">
                            <div className="nav-buttons">
                                ...
                                <ul className="nav nav-pills main-panel-search for-bigger-device" id="pills-tab2" role="tablist">

                                    <li className="nav-item" role="presentation">
                                        <button className={`nav-link ${isActive ? 'active' : ''}`} id="tour-tab" data-bs-toggle="pill" data-bs-target="#tour" type="button" role="tab" aria-controls="tour" aria-selected="true">
                                            {!isActive && <GiPalmTree />
                                            }
                                            Holiday Packages
                                        </button>
                                    ...
                                    <li className="nav-item" role="presentation">
                                        <button className="nav-link" id="activities-tab" data-bs-toggle="pill" data-bs-target="#activities" type="button" role="tab" aria-controls="activities" aria-selected="false">
                                            {!isActive && <MdOutlineSportsHandball />}
                                    ...
                                    <li className="nav-item hide-for-small-screen" role="presentation">
                                        <button className="nav-link" id="activities-tab" data-bs-toggle="pill" data-bs-target="#activities" type="button" role="tab" aria-controls="activities" aria-selected="false">
                                            {!isActive && <FaTaxi />}
...
export default Home2BannerPackgeList
